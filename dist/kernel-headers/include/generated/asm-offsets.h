...
#define THREAD_CPU_CONTEXT 3664 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4760 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4656 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4736 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4752 /* offsetof(struct task_struct, thread.mte_ctrl) */
